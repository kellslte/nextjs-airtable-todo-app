...
const TodoForm = () => {
  ...
  return (
      <form className="form my-6" method="POST" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="w-full rounded bg-blue-500 hover:bg-blue-600 text-whie py-2 px-4">Submit</button>
    </form>
  )
}
